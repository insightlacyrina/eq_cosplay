...
public final class I18n: @unchecked Sendable {
    ...
    private static let translations: [Language: [String: String]] = [
        .zh: [
            ...
            "plot_compensation": "补偿曲线",
            "toggle_plot_mode": "切换补偿曲线 / 三组频响曲线",
        ...
        .en: [
            ...
            "plot_compensation": "Correction Curve",
            "toggle_plot_mode": "Toggle Correction Curve / 3-Curve View",
        ...
        .ja: [
            ...
            "plot_compensation": "補正曲線",
            "toggle_plot_mode": "補正曲線 / 3種周波数応答の切替",
            "plot_delta": "差分カーブ",
